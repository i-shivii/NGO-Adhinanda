...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/testimonials.css">
...
<div class="people">
    ...
    <div class="top">
      <div class="img">
        <img src="assets/operator.jpg">
    </div>
  <p class="info"> I’m so grateful to the Aadhinanda  foundation for involving me in the various initiatives they have undertaken, to give back to the community. In the 2 years I’ve known about Aadhinanda Foundation, they have never shied away from a chance to help the community. Our first initiative was the Plate to Planet initiative, where we enabled children to grow their own “kitchen gardens” and nurture these gardens.  
</p>
    </div>
    <div class="share">
    ...
    <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
...
<div class="people">
    ...
    <span>Pushpa Kumari</span>
    <div class="top">
      <div class="img">
        <img src="assets/operator.jpg">
    </div>
  <p class="info">The relentless work of the Aadhinanda foundation and the volunteers, who have devoted themselves to the cause, has brought about a significant change. I would like to thank them for including me in their noble causes and I wish them the best for all their future endeavors.The Aadhinanda  foundation and its Volunteers worked year long to restore the balance between Development and the Environment in the city of Bihar. </p>
    </div>
    <div class="share">
...
<div class="people">
    ...
    <span>Shiv Shankar Prasad</span>
    <div class="top">
      <div class="img">
        <img src="assets/operator.jpg">
    </div>
    
  <p class="info">On behalf of the 'Aadhinanda  foundation',SHIV SHANKAR PRASAD conducted an intensive 8 day Steiner-Waldorf Education Early Years Training in Kathmandu, Nepal in 2023. Participants were delighted with the broad base of the training, giving a healthy balance between theoretical and practical, creative activities. SHIV SHANKAR  knowledge base is extensive and he shares his knowledge in a readily accessible manner. </p>
    </div>
    <div class="share">
